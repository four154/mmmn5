var rid='r190a4624bcax08f76163-x-u8lekl';
$("style:eq(0)").append(`#d2 .roomh[onclick="rjoin('190a4624bcax08f76163-x-u8lekl');" v="1" n="omar"]{
...
$(`<style>
.nosel d-flex room r190a4624bcax08f76163-x-u8lekl .fitimg.u-pic.borderg {
  letter-spacing: 1px;
  background-size: 108% 108%;
  -webkit-text-fill-color: white;
  animation: grad 2s cubic-bezier(.445,.05,.55,.95) alternate infinite;
}
.nosel d-flex room r190a4624bcax08f76163-x-u8lekl .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
  letter-spacing: 1px;
...
.nosel d-flex room r190a4624bcax08f76163-x-u8lekl.bord {border-inline: 0px solid #4c121e !important;}
.nosel d-flex room r190a4624bcax08f76163-x-u8lekl .dots.mini.u-msg {
    text-align: center;
...
.nosel.d-flex.room.r1909dd41270x60e35f1-xhz6h05 {
    background-image: url(https://up6.cc/2024/07/172074275880765.gif);
...
.nosel d-flex room r190a4624bcax08f76163-x-u8lekl .u-topic.dots {
